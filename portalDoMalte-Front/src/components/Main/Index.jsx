...
import MyBeer from "../../assets/mybeer.png";
        ...
        <div className={styles.firstSection}>
          ...
          <div className={styles.txt}>
            ...
            <p>
              ...
              mais segura para se beber e, por isso, em algumas regiões, o
              consumo de cerveja era bem maior do que água, e a bebida tão
        ...
        <div className={styles.secondSection}>
          <div className={styles.txt}>
            ...
            <p>
              ...
              menor custo, influenciando fortemente no gosto da bebida, tornando
              a produção em grande escala e em grandes fábricas, deixando em
              baixa as peculiaridades da cerveja artesanal.
            </p>
            <p>
        ...
        <div className={styles.thirdSection}>
          ...
          <div className={styles.txt}>
            ...
            <p>
              ...
              consumida era o vinho, já que as características climáticas
              favorecem a plantação das uvas. Mas os povos que viviam ao norte,
              conhecidos como “bárbaros”, tinham como principal bebida a
              cerveja. Eram eles os Germanos, Vikings, Gauleses, Celtas, Godos
              entre outros.
            </p>
            <p>
              ...
              produtores e consumidores de cervejas. Algumas formas de produção
              poderiam variar um pouco, e cada povo tinha a sua fórmula mágica
              de produzir a sua cerveja artesanal. Na história da cerveja tem
              até uma pá de madeira mágica dos vikings A história da cerveja dos
              Vikings também tem a cerveja como bebida predileta, e como
              tradição de família uma receita “secreta”.
            </p>
            <p>
              ...
              cerveja. Na verdade essa pá estava cheia de leveduras responsáveis
              pelo processo de fermentação da cerveja, mas como eles não tinham
              esse conhecimento, achavam a “mágica” da cerveja dar certo, só era
              possível se usassem aquela pá de madeira específica para a mistura
